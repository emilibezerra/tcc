close all; clear;
B10 = imread("LC08_L2SP_216066_20161006_20200906_02_T1_ST_B10.TIF");
B4 = imread("LC08_L2SP_216066_20161006_20200906_02_T1_SR_B4.TIF");
B5 = imread("LC08_L2SP_216066_20161006_20200906_02_T1_SR_B5.TIF");
figure; imshow(B10, []);
...
%Lλ=MLQcal+AL
L  = ( RADIANCE_MULT_BAND_10 .* double(B10))+RADIANCE_ADD_BAND_10;
figure; imshow(L, []);
